...
// For simpleList
function filterSimpleList(item){
    return item.includes(query)
}
let filteredLists = simpleList.filter(filterSimpleList);
console.log(filteredList);
...
function searchHikes(list, q) {
    ...
    // Sorting by distance (convert to number if needed)
